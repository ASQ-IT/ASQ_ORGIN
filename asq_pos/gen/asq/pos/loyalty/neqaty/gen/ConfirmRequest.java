...
public class ConfirmRequest {
    ...
    @XmlElementRef(name = "oneTimePassword", type = JAXBElement.class, required = false)
    protected JAXBElement<String> oneTimePassword;
     ...
     *     
     */
    public JAXBElement<String> getOneTimePassword() {
     ...
     *     
     */
    public void setOneTimePassword(JAXBElement<String> value) {
