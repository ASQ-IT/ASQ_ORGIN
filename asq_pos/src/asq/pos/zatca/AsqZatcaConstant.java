...
public interface AsqZatcaConstant {
	...
	String ZATCA_TENDER_TYPE_CODE_CURRENCY = "CURRENCY";
	String ZATCA_TENDER_TYPE_CODE_CREDIT = "CREDIT_CARD";
	String ZATCA_TENDER_TYPE_CODE_DEBIT = "DEBIT_CARD";
	String ZATCA_TENDER_TYPE_CODE_PAYBYLINK = "PAY_BY_LINK";
