...
public class AsqZatcaCertRegistrationServicesImpl implements IAsqZatcaCertRegistrationServices {
	...
	private static final ServiceType<IAsqSubmitZatcaCertServiceRequest, IServiceResponse> ZATCA_CERT_GEN_SRV = new ServiceType<IAsqSubmitZatcaCertServiceRequest, IServiceResponse>(
			"ZATCA_CERT_GEN_SRV");

	private static final ServiceType<IAsqSubmitZatcaCertServiceRequest, IServiceResponse> ZATCA_CERT_GEN_INVOICE_SRV = new ServiceType<IAsqSubmitZatcaCertServiceRequest, IServiceResponse>(
			"ZATCA_CERT_GEN_INVOICE_SRV");

	private static final ServiceType<IAsqSubmitZatcaCertServiceRequest, IServiceResponse> ZATCA_CERT_CSIDS_SRV = new ServiceType<IAsqSubmitZatcaCertServiceRequest, IServiceResponse>(
			"ZATCA_CERT_CSIDS_SRV");
	...
	@Override
	public IServiceResponse submitCSIDSForRegistration(IAsqSubmitZatcaCertServiceRequest paramAsqISubmitZatcaCertServiceRequest) throws ServiceException {
		try {
	...
	@Override
	public IServiceResponse submitZatcaInvoiceForRegistration(IAsqSubmitZatcaCertServiceRequest paramAsqISubmitZatcaCertServiceRequest) throws ServiceException {
		try {
