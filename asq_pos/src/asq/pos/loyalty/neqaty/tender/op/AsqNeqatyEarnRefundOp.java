...
//						LOG.info("Neqaty Earn Reward API Cashier selected YES to link customer to the transaction");
//						return this.HELPER.getCompleteStackChainResponse(OpChainKey.valueOf("CUST_ASSOCIATION"));
//					}
//				}
//			}
//			return HELPER.getPromptResponse("ASQ_Neqaty_CUSTOMER_UNAVAILABLE",
...
//	}
	...
	private IOpResponse refundEarnPoints(String custMobileNmbr) {
	...
	//	request.setTransactionReference();// transactionreference from the earnponts call response
