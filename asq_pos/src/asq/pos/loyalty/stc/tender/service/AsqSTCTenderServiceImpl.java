...
public class AsqSTCTenderServiceImpl implements IAsqSTCLoyaltyTenderService {
	...
	private static final ServiceType<IAsqSTCLoyaltyServiceRequest, IServiceResponse> ASQ_STC_TENDER_SERVICE = new ServiceType<IAsqSTCLoyaltyServiceRequest, IServiceResponse>("ASQ_STC_TENDER_SERVICE");

	@Override
	public IServiceResponse submitOTPRequest(IAsqSTCLoyaltyServiceRequest argRequest) throws ServiceException {
		
		try {
			IServiceHandler<IAsqSTCLoyaltyServiceRequest, IServiceResponse> serviceHandler = _serviceHandlerFactory.getServiceHandler(ASQ_STC_TENDER_SERVICE);
			IServiceResponse response = serviceHandler.handleService(argRequest,ASQ_STC_TENDER_SERVICE);
			return response;
