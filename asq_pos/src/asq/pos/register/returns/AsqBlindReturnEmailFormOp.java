...
/**
 * @author SA20547171 Using NeqatyOtp to capture OTP
 */
public class AsqBlindReturnEmailFormOp extends AbstractFormOp<AsqNeqatyOTPEditModel> {

	private static final Logger LOG = LogManager.getLogger(AsqBlindReturnEmailFormOp.class);
	...
	protected AsqNeqatyOTPEditModel createModel() {
		return new AsqNeqatyOTPEditModel("_asqCaptureReturnOTPTitle", "_asqCaptureReturnOTPDescription");
	}
	...
	protected IOpResponse handleDataAction(IXstDataAction argAction) {
		...
		try {
			if (XstDataActionKey.ACCEPT.equals(argAction.getActionKey())) {
				...
				int actualOTP = getScopedValue(asq.pos.common.AsqValueKeys.ASQ_RETURN_OTP);
