...
public final class AsqValueKeys {
	...
	public static final ValueKey<BigDecimal> ASQ_STC_PNT_RDMPTN = new ValueKey(BigDecimal.class, "ASQ_STC_PNT_RDMPTN");

	public static final ValueKey<String> ASQ_ZATCA_QR_CODE = new ValueKey(String.class, "");

	public static final ValueKey<String> TAMARA_RESPONSE = new ValueKey(String.class, "TAMARA_RESPONSE");
