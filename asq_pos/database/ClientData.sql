...
---- TOLA ---
----########
Insert into ITM_ITEM_DIMENSION_TYPE (ORGANIZATION_ID,DIMENSION_SYSTEM,DIMENSION,ORG_CODE,ORG_VALUE,SEQ,SORT_ORDER,DESCRIPTION,PROMPT_MSG,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'ASQ_TOLA','TOLA','*','*',1,10,'+ASQ_TOLA_DESC',null,'BASEDATA',to_timestamp('15-APR-24 01.07.24.322000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('15-APR-24 01.07.24.322000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);

Insert into ITM_ITEM_DIMENSION_VALUE (ORGANIZATION_ID,DIMENSION_SYSTEM,DIMENSION,VALUE,ORG_CODE,ORG_VALUE,SORT_ORDER,DESCRIPTION,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'ASQ_TOLA','TOLA','HALF_TOLA','*','*',20,'Half Tola','BASEDATA',to_timestamp('15-APR-24 01.07.24.107000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('15-APR-24 01.07.24.107000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);
Insert into ITM_ITEM_DIMENSION_VALUE (ORGANIZATION_ID,DIMENSION_SYSTEM,DIMENSION,VALUE,ORG_CODE,ORG_VALUE,SORT_ORDER,DESCRIPTION,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'ASQ_TOLA','TOLA','ONE_TOLA','*','*',10,'One Tola','BASEDATA',to_timestamp('15-APR-24 01.07.24.107000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('15-APR-24 01.07.24.107000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);
Insert into ITM_ITEM_DIMENSION_VALUE (ORGANIZATION_ID,DIMENSION_SYSTEM,DIMENSION,VALUE,ORG_CODE,ORG_VALUE,SORT_ORDER,DESCRIPTION,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'ASQ_TOLA','TOLA','QUATOR_TOLA','*','*',30,'Quator Tola','BASEDATA',to_timestamp('15-APR-24 01.07.24.107000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('15-APR-24 01.07.24.107000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);

Insert into COM_TRANSLATIONS (ORGANIZATION_ID,LOCALE,TRANSLATION_KEY,ORG_CODE,ORG_VALUE,TRANSLATION,EXTERNAL_SYSTEM,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'DEFAULT','+ASQ_TOLA_DESC','*','*','TOLA',null,'BASEDATA',to_timestamp('15-APR-24 01.07.22.913000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('15-APR-24 01.07.22.913000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);

Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','TOLA','_fds.unitOfMeasure.TOLA.name','_fds.unitOfMeasure.TOLA.symbol',12,2,'BASEDATA',to_timestamp('12-NOV-24 07.18.15.694000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('12-NOV-24 07.18.15.694000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','HTOLA','_fds.unitOfMeasure.HTOLA.name','_fds.unitOfMeasure.HTOLA.symbol',6,2,'BASEDATA',to_timestamp('12-NOV-24 07.18.15.694000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('12-NOV-24 07.18.15.694000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','QTOLA','_fds.unitOfMeasure.QTOLA.name','_fds.unitOfMeasure.QTOLA.symbol',3,2,'BASEDATA',to_timestamp('12-NOV-24 07.18.15.694000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'BASEDATA',to_timestamp('12-NOV-24 07.18.15.694000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null);
