...
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','TOLA','_fds.unitOfMeasure.TOLA.name','_fds.unitOfMeasure.TOLA.symbol',12,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null);
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','HTOLA','_fds.unitOfMeasure.HTOLA.name','_fds.unitOfMeasure.HTOLA.symbol',6,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null);
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','QTOLA','_fds.unitOfMeasure.QTOLA.name','_fds.unitOfMeasure.QTOLA.symbol',3,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null)

Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','2TOLA','_fds.unitOfMeasure.2TOLA.name','_fds.unitOfMeasure.2TOLA.symbol',24,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null)
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','3TOLA','_fds.unitOfMeasure.3TOLA.name','_fds.unitOfMeasure.3TOLA.symbol',36,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null)
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','5TOLA','_fds.unitOfMeasure.5TOLA.name','_fds.unitOfMeasure.5TOLA.symbol',60,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null)
Insert into COM_MEASUREMENT (ORGANIZATION_ID,DIMENSION,CODE,NAME,SYMBOL,FACTOR,QTY_SCALE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE,RECORD_STATE) values ($(OrgID),'TOLA','10TOLA','_fds.unitOfMeasure.10TOLA.name','_fds.unitOfMeasure.10TOLA.symbol',120,2,'BASEDATA',GETUTCDATE(),'BASEDATA',GETUTCDATE(),null)
